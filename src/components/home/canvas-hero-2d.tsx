...
/*
 * Canvas-2D fallback for the pixel-reveal hero — used when WebGL isn't
 * available. Blocky cell grid, dithered radial reveal, hold-to-grow.
 */
